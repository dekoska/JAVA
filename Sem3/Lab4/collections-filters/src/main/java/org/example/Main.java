...
public class Main {
    public static void main(String[] args){
        ...
        IFilterPeople byIncomeToGenericFilter = new GeneralFilter(x->x.getIncomeTo()>0, (x,y)->y.getIncome()<x.getIncomeTo());
        IFilterPeople byIncomeFromGenericFilter = new GeneralFilter(x->x.getIncomeFrom()>0, (x,y)->y.getIncome()>x.getIncomeFrom());
